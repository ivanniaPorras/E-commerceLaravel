...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6 text-gray-900">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">Modifica el producto: {{ $producto->nombre }}</p>
                    </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <form method="POST" action="{{ route('admin.products.update', $producto) }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" required
                                   ...
                                   value="{{ old('nombre', $producto->nombre) }}" placeholder="Ej: Laptop HP Pavilion">
                            @error('nombre')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="stock" id="stock" min="0" required
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                   value="{{ old('stock', $producto->stock) }}" placeholder="0">
                            @error('stock')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        @if($producto->imagen_url)
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="text-sm text-gray-600">Imagen actual: {{ basename($producto->imagen_url) }}</p>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Formatos: JPG, PNG, GIF. Máximo 2MB. Deja vacío para mantener la imagen actual.</p>
                        @error('imagen')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" 
                                ...
                                onmouseover="this.style.backgroundColor='#047857'"
                                onmouseout="this.style.backgroundColor='#059669'">
                            <i class="bi bi-check mr-2"></i>Actualizar Producto
                        </button>
                    </div>
                </form>
            </div>
